...
**Markdown Viewer 다크 모드**: 슬레이트 블루 톤 대신 **중립 차콜**을 쓴다. 페이지 배경은 `#262626` 전후, 패널·탑바·본문 카드 면은 **`#333333` 근처**(`#2e2e2e`~`#383838`로 미세 단계), 테두리·호버는 `#404040`~`#525252`로만 구분해 전체를 검정에 가깝게 유지한다.
...
| 다크 시 배경(뉴트럴) | 바깥 `#262626` 전후, 면 `#333333` 전후, 보더 `#404040`~`#525252` (본 뷰어 기준) |
| 다크 시 배경(슬레이트 계열 예시) | `bg-slate-900`, 패널 `bg-slate-800` |
